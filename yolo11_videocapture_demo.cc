...
int main(int argc, char **argv)
{
    ...
    */
    const char *model_path = "/home/ubuntu/projects/yolo11_demo/model/yolo11n.rknn";
    //const char *device_path = "/home/ubuntu/projects/yolo11_demo/model/1.mp4";
    const char *device_path = "31";
    int ret;
    cv::Mat frame, image;
    ...
    // 摄像头
    if (isdigit(std::stoi(device_path))) {
        int camera_id = 31;//atoi(device_path);
        cap.open(camera_id);
